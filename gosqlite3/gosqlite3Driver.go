...
func (my *gosqlite3Driver) toByte() []byte {
	...
	ret = binary.BigEndian.AppendUint16(ret, my.pagesize)
	...
	ret = binary.BigEndian.AppendUint32(ret, my.filechangecounter)
	ret = binary.BigEndian.AppendUint32(ret, my.sizeofdatabaseinpages)
	ret = binary.BigEndian.AppendUint32(ret, my.pagenumberoffirst)
	ret = binary.BigEndian.AppendUint32(ret, my.totalnumberoffreelist)
	ret = binary.BigEndian.AppendUint32(ret, my.schemacookie)
	ret = binary.BigEndian.AppendUint32(ret, my.schemaformat)
	ret = binary.BigEndian.AppendUint32(ret, my.defaultpagecachesize)
	ret = binary.BigEndian.AppendUint32(ret, my.pagenumberoflargestroot)
	ret = binary.BigEndian.AppendUint32(ret, my.databasetextencoding)
	ret = binary.BigEndian.AppendUint32(ret, my.userversion)
	ret = binary.BigEndian.AppendUint32(ret, my.flagincremental)
	ret = binary.BigEndian.AppendUint32(ret, my.applicationID)
	ret = append(ret, my.reserved[:]...)
	ret = binary.BigEndian.AppendUint32(ret, my.versionvalidfornumber)
	ret = binary.BigEndian.AppendUint32(ret, my.SQLITEVERSIONNUMBER)
	return ret
}
